...
# Mock feedback storage (replace with DB model in production)
feedback_storage = []

# Initialize services
# In a real app, you might inject this via Depends
...
def validate_student_access(student_id: str, tenant_id: str, db: Session, require_voice: bool = False) -> Student:
    """Validate student access and permissions using database"""
    import uuid
    ...
    try:
        ...
        tenant_uuid = uuid.UUID(tenant_id)
         ...
         raise HTTPException(
            ...
            detail="Invalid student ID or tenant ID format"
        )

    # Allow query by id or student_id field
    ...
    # Assuming voice is enabled for all students for now, or add a column later
...
async def query_assistant(
    ...
    try:
        ...
        # Validate student access with DB
        ...
        response = AssistantQueryResponse(
            ...
            student_id=str(assistant_response['student_id']),
...
async def get_student_history(
    ...
    try:
        ...
        student = validate_student_access(student_id, tenant_id, db)
        
        # Get interaction history
        history_data = assistant_service.get_interaction_history(student_id, tenant_id, limit)
...
async def submit_feedback(
    ...
    try:
        ...
        # Validate student access
        student = validate_student_access(feedback.student_id, tenant_id, db)
